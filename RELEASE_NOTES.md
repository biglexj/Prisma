...
### Resumen
Actualización **Prisma v1.0.1** orientada a la integración de **Luna Fetch** en la barra de herramientas y sinergia con Aurora Synapse, el nuevo **Convertidor Prisma** por lotes con soporte de carpetas completas y menús contextuales, agrupación inteligente de música por metadatos de álbum con vista de detalle dedicada, y perfeccionamiento de alta precisión en **Prisma Quick Look** para Windows 11 con pestañas.

### Detalles
- **Centro de Descargas Luna Fetch e Integración de Ecosistema**: Nueva sección dedicada en la barra de herramientas para Luna Fetch con analizador y envío rápido de URLs, lanzamiento directo de la aplicación de escritorio y acceso inmediato a las descargas para su reproducción y conversión en Prisma.

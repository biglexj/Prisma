...
- [x] V12 — Agente — Comprobar que la ventana de documentos dimensione al 60% de pantalla (`screen_w * 0.60`), con padding tipográfico editorial de 24px arriba, 40px laterales y 32px abajo (`padding: 24px 40px 32px;`).

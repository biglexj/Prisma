...
- [x] V12 — Agente — Comprobar que la ventana de documentos dimensione al 60% de pantalla (`screen_w * 0.60`), con padding tipográfico de 16px arriba/abajo y 20px laterales (`padding: 16px 20px;`).

...
- [x] T12 — Mantener el ancho de ventana al 60% de pantalla (`screen_w * 0.60`), calibrando el padding tipográfico a 16px arriba/abajo y 20px en laterales (`padding: 16px 20px;`).

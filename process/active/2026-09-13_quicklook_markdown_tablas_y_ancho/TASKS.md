...
- [x] T12 — Mantener el ancho de ventana al 60% de pantalla (`screen_w * 0.60`), calibrando el padding tipográfico editorial a 24px arriba, 40px en laterales y 32px abajo (`padding: 24px 40px 32px;`).

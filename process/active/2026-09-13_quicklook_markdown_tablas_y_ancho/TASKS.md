...
- [x] T12 — Mantener el ancho de ventana al 60% de pantalla (`screen_w * 0.60`), conservar padding superior en 14px y calibrar padding lateral a 16px alineado con la barra de herramientas.

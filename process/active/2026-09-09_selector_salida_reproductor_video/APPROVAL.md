# Selector de Salida y Ecualizador en Reproductor de Vídeo — Aprobación
...
- Integración del selector de dispositivos de salida de audio y acceso al ecualizador DSP en la barra de controles de `VideoPlayer`.

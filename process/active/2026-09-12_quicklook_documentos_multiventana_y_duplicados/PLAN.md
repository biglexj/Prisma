...
- [ ] Las vistas de documentos en QuickLook tienen dimensiones más amplias (+5% alto, +8-10% ancho).
- [ ] La cabecera de QuickLook incluye botón «Editar» funcional para documentos.
- [ ] Al pulsar «Abrir» en un documento desde QuickLook, la ventana principal de Prisma muestra el documento en `DocumentViewer` completo.
- [ ] Rutas con `@` o caracteres reservados se cargan sin pantalla blanca en imágenes/vídeos.
- [ ] Las ventanas desacopladas cierran al primer clic sin bloquearse ni mostrar "Listo para previsualizar".
- [ ] Menú contextual nativo de Edge bloqueado en la vista previa.
- [ ] Motor de duplicados funcional con comparación de similitud perceptual y visualización de resultados.
